...
// Features
import { getExtension, getParameter, getShaderPrecisionFormat } from './getWebGLFeatures';
...
export default ((): any => {
  ...
  const features = {
    ...
    specific: {
      ...
      maxFragmentInputComponents: getParameter(gl, GL_MAX_FRAGMENT_INPUT_COMPONENTS),
      maxFragmentUniformBlocks: getParameter(gl, GL_MAX_FRAGMENT_UNIFORM_BLOCKS),
      maxFragmentUniformComponents: getParameter(gl, GL_MAX_FRAGMENT_UNIFORM_COMPONENTS),
      ...
      maxVertexOutputComponents: getParameter(gl, GL_MAX_VERTEX_OUTPUT_COMPONENTS),
      maxVertexUniformBlocks: getParameter(gl, GL_MAX_VERTEX_UNIFORM_BLOCKS),
      maxVertexUniformComponents: getParameter(gl, GL_MAX_VERTEX_UNIFORM_COMPONENTS),
      minProgramTexelOffset: getParameter(gl, GL_MIN_PROGRAM_TEXEL_OFFSET),
      uniformBufferOffsetAlignment: getParameter(gl, GL_UNIFORM_BUFFER_OFFSET_ALIGNMENT),
    },
  };
