...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../dist/alpine-toolkit.umd.js":[function(require,module,exports) {
var define;
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : (global = global || self, factory(global.AlpineToolkit = {}));
  ...
  var isRequestIdleCallbackSupported = function () {
  ...
  var registerAnalytics = function registerAnalytics(trackingIdentifier) {
    ...
    if (!isDoNotTrackEnabled) {
      ...
      (function (i, s, o, g, r, a, m) {
        ...
        i.GoogleAnalyticsObject = r; // @ts-ignore Google Analytics snippet

        i[r] = // @ts-ignore Google Analytics snippet
        i[r] || // tslint:disable-next-line:only-arrow-functions
        function () {
          // @ts-ignore Google Analytics snippet
          (i[r].q = i[r].q || []).push(arguments);
        }, // @ts-ignore Google Analytics snippet
        i[r].l = 1 * new Date(); // @ts-ignore Google Analytics snippet

        a = s.createElement(o), m = s.getElementsByTagName(o)[0]; // @ts-ignore Google Analytics snippet

        a.async = 1; // @ts-ignore Google Analytics snippet

        a.src = g; // @ts-ignore Google Analytics snippet

        m.parentNode.insertBefore(a, m);
      })(window, document, 'script', 'https://www.google-analytics.com/analytics.js', 'ga'); // @ts-ignore Google Analytics snippet


      ga('create', "" + trackingIdentifier, 'auto'); // @ts-ignore Google Analytics snippet
  ...
  var recordAnalyticsEvent = function recordAnalyticsEvent(record) {
    if (record === void 0) {
      record = {};
    } // @ts-ignore Google Analytics snippet
  ...
  var isAutoplayAllowed = function isAutoplayAllowed() {
  ...
  var createAudioContext = function createAudioContext(desiredSampleRate) {
    if (desiredSampleRate === void 0) {
      desiredSampleRate = 44100;
    } // @ts-ignore window.AudioContext and window.webkitAudioContext are not available as types


    var context = new (window.AudioContext || window.webkitAudioContext)(); // https://stackoverflow.com/questions/17892345/webkit-audio-distorts-on-ios-6-iphone-5-first-time-after-power-cycling
    ...
    if (/(iPhone|iPad)/i.test(navigator.userAgent) && context.sampleRate !== desiredSampleRate) {
      ...
      dummy.start(0);
      dummy.disconnect(); // Dispose old context

      context.close(); // @ts-ignore window.AudioContext and window.webkitAudioContext are not available as types
  ...
  var unlockAutoplay = function unlockAutoplay(element) {
    return new Promise(function (resolve, reject) {
      ...
      if (context.state === 'suspended') {
        ...
        var unlock_1 = function unlock_1() {
    ...
    _createClass2(Store, [{
      ...
      value: function _withIDBStore(type, callback) {
        ...
        return this._dbp.then(function (db) {
          return new Promise(function (resolve, reject) {
            var transaction = db.transaction(_this2.storeName, type);
            ...
            callback(transaction.objectStore(_this2.storeName));
          });
        });
      }
    }]);
  ...
  var isAllowedAsKey = function isAllowedAsKey(key) {
    if (typeof key === 'number' || typeof key === 'string') {
      return true;
    }

    if (key === 'object' && key) {
      if (Array.isArray(key) || 'setUTCFullYear' in key || typeof ArrayBuffer === 'function' && ArrayBuffer.isView(key) || 'byteLength' in key && 'length' in key) {
        return true;
      }
    }
  ...
  function () {
    ...
    function PersistentCache(databaseName, storeName) {
      if (databaseName === void 0) {
        databaseName = 'persistent-cache-db';
      }

      if (storeName === void 0) {
        storeName = 'persistent-cache-store';
    ...
    PersistentCache.prototype.get = function (key) {
      ...
      return new Promise(function (resolve) {
        get(key, _this.store).then(function (value) {
          resolve(value);
        }).catch(function (err) {
    ...
    PersistentCache.prototype.getKeys = function () {
      ...
      return new Promise(function (resolve) {
        keys(_this.store).then(function (storeKeys) {
          resolve(storeKeys);
        }).catch(function (err) {
  ...
  var setCookie = function setCookie(key, value, expiryDays) {
    if (expiryDays === void 0) {
      expiryDays = 365;
    }
  ...
  function onConnectionChange() {
    ...
    var connectionEffectiveType = // @ts-ignore navigator.connection does not exist yet as a type but is valid in the browser
    navigator.connection && navigator.connection.effectiveType || '4g'; // @ts-ignore navigator.connection does not exist yet as a type but is valid in the browser
  ...
  var listenToConnectionChange = function listenToConnectionChange() {
  ...
  var stopListeningToConnectionChange = function stopListeningToConnectionChange() {
  ...
  var listenToOrientationChange = function listenToOrientationChange() {
  ...
  var stopListeningToOrientationChange = function stopListeningToOrientationChange() {
  ...
  var prefix = 'hidden' in document && Object.keys(key) || webkit[0] in document && webkit || ms[0] in document && ms || [];
  /**
  ...
  var listenToVisibilityChange = function listenToVisibilityChange() {
  ...
  var stopListeningToVisibilityChange = function stopListeningToVisibilityChange() {
  ...
  var listenToWindowSizeChange = function listenToWindowSizeChange() {
  ...
  var stopListeningToWindowSizeChange = function stopListeningToWindowSizeChange() {
  ...
  function () {
    ...
    function DetectUA(forceUserAgent) {
      ...
      this.cache = new Map();
      this.userAgent = forceUserAgent ? forceUserAgent : window && window.navigator ? window.navigator.userAgent : '';
    ...
    Object.defineProperty(DetectUA.prototype, "isMobile", {
      ...
      get: function get() {
        ...
        if (cached) {
          ...
          this.iOS === 'iphone' || this.iOS === 'ipod' || // Android
          this.android || // Nexus mobile
    ...
    Object.defineProperty(DetectUA.prototype, "isTablet", {
      ...
      get: function get() {
        ...
        if (cached) {
          ...
          this.iOS === 'ipad' || // Android
          this.android && !/[^-]mobi/i.test(this.userAgent) || // Nexus tablet
  ...
  var isChrome = _typeof(browser) === 'object' && browser.name === 'Chrome';
  var isFirefox = _typeof(browser) === 'object' && browser.name === 'Firefox';
  var isSafari = _typeof(browser) === 'object' && browser.name === 'Safari';
  var isEdge = _typeof(browser) === 'object' && browser.name === 'Microsoft Edge';
  var isInternetExplorer = _typeof(browser) === 'object' && browser.name === 'Internet Explorer';
  var isOpera = _typeof(browser) === 'object' && browser.name === 'Opera';
  var isSamsungBrowser = _typeof(browser) === 'object' && browser.name === 'Samsung Internet for Android';
  var isYandexBrowser = _typeof(browser) === 'object' && browser.name === 'Yandex Browser';
  var isUCBrowser = _typeof(browser) === 'object' && browser.name === 'UC Browser';
  var isChromium = _typeof(browser) === 'object' && browser.name === 'Chromium';
  /**
  ...
  var getBrowserType = {
    ...
    browserName: _typeof(browser) === 'object' && browser.name || '',
    browserVersion: _typeof(browser) === 'object' && browser.version || ''
  };
  /**
  ...
  var GL_STENCIL_TEST = 0x0b90; // Shaders
  ...
  var GL_MAX_CUBE_MAP_TEXTURE_SIZE = 0x851c; // Shader precision-specified types
  ...
  var GL_MAX_ELEMENT_INDEX = 0x8d6b; // Draw buffers
  ...
  var GL_MAX_CLIENT_WAIT_TIMEOUT_WEBGL = 0x9247; // Vendor

  /**
   * Collect and structure all major device and browser specific WebGL2 features
   */

  var getWebGL2Features = function getWebGL2Features() {
    var attributes = {
      stencil: true
    };
    var canvas = document.createElement('canvas');
    var gl = canvas.getContext('webgl2', attributes); // @ts-ignore
    ...
    var glExtensionDebugRendererInfo = gl.getExtension('WEBGL_debug_renderer_info'); // Enable features
    // @ts-ignore

    gl.enable(GL_STENCIL_TEST); // Enable extensions
    // @ts-ignore

    var glAnisotropicExtension = // @ts-ignore
    gl.getExtension('EXT_texture_filter_anisotropic') || // @ts-ignore
    gl.getExtension('WEBKIT_EXT_texture_filter_anisotropic') || // @ts-ignore
    ...
    var features = {
      ...
      base: {
        ...
        rendererUnmasked: glExtensionDebugRendererInfo && // @ts-ignore
        ...
        vendorUnmasked: glExtensionDebugRendererInfo && // @ts-ignore
      ...
      general: {
        ...
        precision: {
          fragmentShaderHighPrecision: [// @ts-ignore
          gl.getShaderPrecisionFormat(GL_FRAGMENT_SHADER, GL_HIGH_FLOAT).rangeMin, // @ts-ignore
          gl.getShaderPrecisionFormat(GL_FRAGMENT_SHADER, GL_HIGH_FLOAT).rangeMax, // @ts-ignore
          gl.getShaderPrecisionFormat(GL_FRAGMENT_SHADER, GL_HIGH_FLOAT).precision].toString(),
          fragmentShaderLowPrecision: [// @ts-ignore
          gl.getShaderPrecisionFormat(GL_FRAGMENT_SHADER, GL_LOW_FLOAT).rangeMin, // @ts-ignore
          gl.getShaderPrecisionFormat(GL_FRAGMENT_SHADER, GL_LOW_FLOAT).rangeMax, // @ts-ignore
          gl.getShaderPrecisionFormat(GL_FRAGMENT_SHADER, GL_LOW_FLOAT).precision].toString(),
          fragmentShaderMediumPrecision: [// @ts-ignore
          gl.getShaderPrecisionFormat(GL_FRAGMENT_SHADER, GL_MEDIUM_FLOAT).rangeMin, // @ts-ignore
          gl.getShaderPrecisionFormat(GL_FRAGMENT_SHADER, GL_MEDIUM_FLOAT).rangeMax, // @ts-ignore
          gl.getShaderPrecisionFormat(GL_FRAGMENT_SHADER, GL_MEDIUM_FLOAT).precision].toString(),
          vertexShaderHighPrecision: [// @ts-ignore
          gl.getShaderPrecisionFormat(GL_VERTEX_SHADER, GL_HIGH_FLOAT).rangeMin, // @ts-ignore
          gl.getShaderPrecisionFormat(GL_VERTEX_SHADER, GL_HIGH_FLOAT).rangeMax, // @ts-ignore
          gl.getShaderPrecisionFormat(GL_VERTEX_SHADER, GL_HIGH_FLOAT).precision].toString(),
          vertexShaderLowPrecision: [// @ts-ignore
          gl.getShaderPrecisionFormat(GL_VERTEX_SHADER, GL_LOW_FLOAT).rangeMin, // @ts-ignore
          gl.getShaderPrecisionFormat(GL_VERTEX_SHADER, GL_LOW_FLOAT).rangeMax, // @ts-ignore
          gl.getShaderPrecisionFormat(GL_VERTEX_SHADER, GL_LOW_FLOAT).precision].toString(),
          vertexShaderMediumPrecision: [// @ts-ignore
          gl.getShaderPrecisionFormat(GL_VERTEX_SHADER, GL_MEDIUM_FLOAT).rangeMin, // @ts-ignore
          gl.getShaderPrecisionFormat(GL_VERTEX_SHADER, GL_MEDIUM_FLOAT).rangeMax, // @ts-ignore
          gl.getShaderPrecisionFormat(GL_VERTEX_SHADER, GL_MEDIUM_FLOAT).precision].toString()
        },
        // @ts-ignore
      ...
      extensions: {
        // prettier-ignore
        maxAnisotropy: glAnisotropicExtension // @ts-ignore
        ? gl.getParameter(glAnisotropicExtension.MAX_TEXTURE_MAX_ANISOTROPY_EXT) : 0,
        // @ts-ignore
        ...
        compressedTexturePVRTCExtension: // @ts-ignore
        gl.getExtension('WEBGL_compressed_texture_pvrtc') || // @ts-ignore
        ...
        compressedTextureS3TCSRGBExtension: // @ts-ignore
      ...
      specific: {
        ...
        // @ts-ignore
        maxCombinedFragmentUniformComponents: gl.getParameter( // @ts-ignore
        gl.MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS),
        // @ts-ignore
        maxCombinedUniformBlocks: gl.getParameter(GL_MAX_COMBINED_UNIFORM_BLOCKS),
        // @ts-ignore
        maxCombinedVertexUniformComponents: gl.getParameter( // @ts-ignore
        ...
        // @ts-ignore
        maxTransformFeedbackInterleavedComponents: gl.getParameter( // @ts-ignore
        gl.MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS),
        // @ts-ignore
        maxTransformFeedbackSeparateAttribs: gl.getParameter( // @ts-ignore
        gl.MAX_TRANSFORM_FEEDBACK_SEPARATE_ATTRIBS),
        // @ts-ignore
        maxTransformFeedbackSeparateComponents: gl.getParameter( // @ts-ignore
  ...
  var getWebGLFeatures = function () {
    ...
    var glAnisotropicExtension = gl.getExtension('EXT_texture_filter_anisotropic') || gl.getExtension('WEBKIT_EXT_texture_filter_anisotropic') || gl.getExtension('MOZ_EXT_texture_filter_anisotropic');
    ...
    var features = {
      ...
      extensions: {
        ...
        compressedTextureETC1Extension: gl.getExtension('WEBGL_compressed_texture_etc1') || null,
        compressedTextureETCExtension: gl.getExtension('WEBGL_compressed_texture_etc') || null,
        compressedTexturePVRTCExtension: gl.getExtension('WEBGL_compressed_texture_pvrtc') || gl.getExtension('WEBKIT_WEBGL_compressed_texture_pvrtc') || null,
        compressedTextureS3TCExtension: gl.getExtension('WEBGL_compressed_texture_s3tc') || null,
  ...
  var isAnimationWorkletSupported = function () {
    return !!window.CSS && !!window.CSS.animationWorklet || false;
  }();
  /**
  ...
  var isAudioWorkletSupported = function () {
    return !!window.AudioWorklet || false;
  }();
  /**
  ...
  var isBroadcastChannelSupported = function () {
    return !!window.BroadcastChannel || false;
  }();
  /**
  ...
  var isGamepadSupported = function () {
  ...
  var isImageBitmapSupported = function () {
    return !!window.ImageBitmap && !!window.createImageBitmap || false;
  }();
  /**
  ...
  var isLayoutWorkletSupported = function () {
    return !!window.CSS && !!window.CSS.layoutWorklet || false;
  }();
  /**
  ...
  var isMutationObserverSupported = function () {
    return !!window.MutationObserver || false;
  }();
  /**
  ...
  var isOffscreenCanvasSupported = function () {
    return !!window.OffscreenCanvas || false;
  }();
  /**
  ...
  var isPaintWorkletSupported = function () {
    return !!window.CSS && !!window.CSS.paintWorklet || false;
  }();
  /**
  ...
  var isPerformanceNowSupported = function () {
    return !!(window.performance && window.performance.now) || false;
  }();
  /**
  ...
  var isPerformanceObserverSupported = function () {
    return !!window.PerformanceObserver || false;
  }();
  /**
  ...
  var isServiceWorkerSupported = function () {
  ...
  var isWebGL2Supported = function isWebGL2Supported() {
    var canvas = document.createElement('canvas'); // NOTE: there is no 'experimental-webgl2' as mentioned in https://webgl2fundamentals.org/webgl/lessons/webgl1-to-webgl2.html

    var gl = canvas.getContext('webgl2'); // @ts-ignore missing type definition
  ...
  var isWebRTCSupported = function () {
    // @ts-ignore missing type definition
    return !!window.RTCPeerConnection && !!window.RTCDataChannelEvent || // @ts-ignore missing type definition
    !!window.webkitRTCPeerConnection || // @ts-ignore missing type definition
    !!window.mozRTCPeerConnection || // @ts-ignore missing type definition
    !!window.msRTCPeerConnection || // @ts-ignore missing type definition
    !!window.oRTCPeerConnection || false;
  }();
  /**
  ...
  var isWebWorkerInlineSupported = function () {
    try {
      // @ts-ignore missing type definition
      var URL_1 = window.URL || window.webkitURL; // @ts-ignore missing type definition
  ...
  var isWebWorkerSupported = function () {
  ...
  var isWebXRSupported = function () {
    return !!navigator.xr || false;
  }();
  /**
  ...
  var getAvailableCPUCoreCount = function () {
  ...
  ***************************************************************************** */
  ...
  var getQueryParameters = function getQueryParameters(url) {
    ...
    return url // Remove ?
    .slice(1) // Split by &
    .split('&') // Find parameters
    .map(function (param) {
      return param.split('=');
    }) // Construct { key: value } pairs
    .reduce(function (values, _a) {
      var key = _a[0],
          value = _a[1]; // @ts-ignore implicit any, has no index structure
  ...
  var LOADER_EXTENSIONS_MAP = new Map([[ELoaderKey.Audio, {
    extensions: ['mp3', 'ogg', 'wav', 'flac']
  }], [ELoaderKey.Font, {
    extensions: ['woff2', 'woff', 'ttf', 'otf', 'eot']
  }], [ELoaderKey.Image, {
    extensions: ['jpeg', 'jpg', 'gif', 'png', 'webp']
  }], [ELoaderKey.ImageBitmap, {
    extensions: ['jpeg', 'jpg', 'gif', 'png', 'webp']
  }], [ELoaderKey.ImageCompressed, {
    extensions: ['ktx']
  }], [ELoaderKey.JSON, {
    extensions: ['json']
  }], [ELoaderKey.Text, {
  ...
  function () {
    function AssetLoader() {
      ...
      this.loadAssets = function (items) {
        var loadingAssets = items.filter(function (item) {
          return item;
        }).map(function (item) {
    ...
    AssetLoader.byDeviceType = function (data) {
      return data.DESKTOP && getBrowserType.isDesktop ? data.DESKTOP : data.TABLET && getBrowserType.isTablet ? data.TABLET : data.MOBILE;
    };
    /**
    ...
    AssetLoader.bySupportedCompressedTexture = function (data) {
      if (getWebGLFeatures) {
        return data.ASTC && getWebGLFeatures.extensions.compressedTextureASTCExtension ? data.ASTC : data.ETC && getWebGLFeatures.extensions.compressedTextureETCExtension ? data.S3TC : data.PVRTC && getWebGLFeatures.extensions.compressedTexturePVRTCExtension ? data.PVRTC : data.S3TC && getWebGLFeatures.extensions.compressedTextureS3TCExtension ? data.S3TC : data.FALLBACK;
      } else {
    ...
    AssetLoader.fetchItem = function (item) {
    ...
    AssetLoader.loadArrayBuffer = function (item) {
      return AssetLoader.fetchItem(item).then(function (response) {
    ...
    AssetLoader.loadImage = function (item) {
      return new Promise(function (resolve, reject) {
        var image = new Image(); // Check if we can decode non-blocking by loading the image asynchronously using image.decode().then(() => ...)
    ...
    AssetLoader.loadImageCompressed = function (item) {
      return AssetLoader.loadArrayBuffer(item).then(function (data) {
        if (data) {
          ...
          var switchEndianness = function switchEndianness(value) {
          ...
          assert(identifier[0] === 0xab || identifier[1] === 0x4b || identifier[2] === 0x54 || identifier[3] === 0x58 || identifier[4] === 0x20 || identifier[5] === 0x31 || identifier[6] === 0x31 || identifier[7] === 0xbb || identifier[8] === 0x0d || identifier[9] === 0x0a || identifier[10] === 0x1a || identifier[11] === 0x0a, 'Texture missing KTX identifier, currently only supporting KTX containers'); // Load the rest of the header in 32 bit int

          var header = new Int32Array(data, 12, 13); // Determine of the remaining header values are recorded
          // in the opposite endianness and require conversion

          var bigEndian = header[0] === 0x01020304; // Must be 0 for compressed textures

          var glType = bigEndian ? switchEndianness(header[1]) : header[1]; // Must be 1 for compressed textures
          ...
          var glInternalFormat = bigEndian ? switchEndianness(header[4]) : header[4]; // Specify GL_RGB, GL_RGBA, GL_ALPHA, etc (un-compressed only)

          var glBaseInternalFormat = bigEndian ? switchEndianness(header[5]) : header[5]; // Level 0 value to be passed to gl.compressedTexImage2D(,,,x,,,)

          var pixelWidth = bigEndian ? switchEndianness(header[6]) : header[6]; // Level 0 value to be passed to gl.compressedTexImage2D(,,,,x,,)

          var pixelHeight = bigEndian ? switchEndianness(header[7]) : header[7]; // Level 0 value to be passed to gl.compressedTexImage3D(,,,,,x,,)

          var pixelDepth = bigEndian ? switchEndianness(header[8]) : header[8]; // Used for texture arrays

          var numberOfArrayElements = bigEndian ? switchEndianness(header[9]) : header[9]; // Used for cubemap textures, should either be 1 or 6

          var numberOfFaces = bigEndian ? switchEndianness(header[10]) : header[10]; // Number of levels; disregard possibility of 0 for compressed textures

          var numberOfMipmapLevels = bigEndian ? switchEndianness(header[11]) : header[11]; // The amount of space after the header for meta-data

          var bytesOfKeyValueData = bigEndian ? switchEndianness(header[12]) : header[12]; // Value of zero is an indication to generate mipmaps at runtime.
          // Not usually allowed for compressed, so disregard.

          numberOfMipmapLevels = Math.max(1, numberOfMipmapLevels); // Check for 2D texture

          assert(pixelHeight !== 0 && pixelDepth === 0, 'Only 2D textures currently supported'); // Check for texture arrays, currently not supported

          assert(numberOfArrayElements === 0, 'Texture arrays not currently supported');
          var mipmaps = []; // Identifier + header elements (not including key value meta-data pairs)
          ...
          for (var level = 0; level < mipmapCount; level++) {
            ...
            var imageSize = new Int32Array(data, dataOffset, 1)[0]; // Image data starts from next multiple of 4 offset
            ...
            for (var face = 0; face < numberOfFaces; face++) {
              ...
              dataOffset += imageSize; // Add padding for odd sized image
    ...
    AssetLoader.loadVideo = function (item) {
      return AssetLoader.fetchItem(item).then(function (response) {
        ...
        return new Promise(function (resolve, reject) {
          var video = document.createElement('video');
          video.preload = 'auto';
          video.autoplay = false; // @ts-ignore playsinline is not recognized as a valid type but it is valid syntax
    ...
    AssetLoader.loadWebAssembly = function (item) {
      if (isWebAssemblySupported) {
        ...
        if (window.WebAssembly.instantiateStreaming) {
          ...
          .then(function (data) {
            return window.WebAssembly.instantiate(data, item.loaderOptions.importObject);
          }).catch(function (err) {
            console.warn(err);
          });
        }
    ...
    AssetLoader.loadXML = function (item) {
      if (!item.mimeType) {
        ...
        item = _assign({}, item, {
          mimeType: AssetLoader.getMimeType(ELoaderKey.XML, extension)
        });
      }
  ...
  var webkit$1 = ['webkitFullscreenEnabled', 'webkitFullscreenElement', 'webkitRequestFullscreen', 'webkitExitFullscreen', 'webkitfullscreenchange', 'webkitfullscreenerror'];
  ...
  var ms$1 = ['msFullscreenEnabled', 'msFullscreenElement', 'msRequestFullscreen', 'msExitFullscreen', 'MSFullscreenChange', 'MSFullscreenError'];
  var prefix$1 = 'fullscreenEnabled' in document && Object.keys(key$1) || webkit$1[0] in document && webkit$1 || moz[0] in document && moz || ms$1[0] in document && ms$1 || [];
  var fullScreen = {
    // @ts-ignore implicit any, has no index structure
    requestFullscreen: function requestFullscreen(element) {
      return element[prefix$1[key$1.requestFullscreen]]();
    },
  ...
  var webkit$2 = ['webkitPointerLockElement', 'webkitRequestPointerLock', 'webkitExitPointerLock', 'webkitpointerlockchange', 'webkitpointerlockerror'];
  var moz$1 = ['mozPointerLockElement', 'mozRequestPointerLock', 'mozExitPointerLock', 'mozpointerlockchange', 'mozpointerlockerror'];
  var ms$2 = ['msPointerLockElement', 'msRequestPointerLock', 'msExitPointerLock', 'mspointerlockchange', 'mspointerlockerror'];
  var prefix$2 = 'pointerLockElement' in document && Object.keys(key$2) || webkit$2[0] in document && webkit$2 || moz$1[0] in document && moz$1 || ms$2[0] in document && ms$2 || [];
  var pointerLock = {
    // @ts-ignore implicit any, has no index structure
    requestPointerLock: function requestPointerLock(element) {
      return element[prefix$2[key$2.requestPointerLock]]();
    },
    ...
    get pointerlockEnabled() {
      // @ts-ignore implicit any, has no index structure
      return Boolean('pointerLockElement' in document || webkit$2[0] in document || moz$1[0] in document || ms$2[0] in document);
    },
  ...
  exports.isAutoplayAllowed = isAutoplayAllowed;
  exports.listenToConnectionChange = listenToConnectionChange;
  exports.listenToOrientationChange = listenToOrientationChange;
  exports.listenToVisibilityChange = listenToVisibilityChange;
  exports.listenToWindowSizeChange = listenToWindowSizeChange;
  ...
  exports.stopListeningToConnectionChange = stopListeningToConnectionChange;
...
var AlpineToolkit = _interopRequireWildcard(require("../dist/alpine-toolkit.umd"));
...
// Features
// --------
console.log(AlpineToolkit.features); // console.log(
...
},{"../dist/alpine-toolkit.umd":"../dist/alpine-toolkit.umd.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
